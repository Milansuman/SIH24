                ...
                try:
                    for match in re.finditer(byte_string, self.data):
                        ...
                        match file_type:
                            ...
                            case "RAR":
                                rar_extractor = rar.RARExtractor(self.data[match.start():])
                                rar_extractor.extract_file(f"extracted_{match.start()}.rar")
                            case "XLSX":
                            ...
                            case "RTF":
                                rtf_extractor = rtf.RTFExtractor(self.data[match.start():])
                                rtf_extractor.extract_file(f"extracted_{match.start()}.rtf")
                            case "EXE":
